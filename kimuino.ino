...
// BASIC (customized CBM Basic 2)
const uint8_t TINY_BASIC_0100[] PROGMEM = {
  0xad, 0x40, 0x17, 0x18, 0xa9, 0xff, 0x20, 0xa0, 0x1e, 0x38, 0x60, 0x00,
...
const uint8_t TINY_BASIC_2000[] PROGMEM = {

};
...
uint8_t read6502(uint16_t address) {
    ...
    // TINY BASIC ROM    
    if (address >= 0x2000 && address <= 0x2900) return pgm_read_byte_near(TINY_BASIC_2000 + (address - 0x2000));
...
void setup()
{
    ...
    //for (int i = 0; i < 320; i++) RAM[i] = pgm_read_byte_near(TINY_BASIC_0100 + i + 0x0100);
}

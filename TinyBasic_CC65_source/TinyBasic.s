...
;  Adopted to run on Arduino based KIM-1 by CMK
;
...
OUT_V    CMP #$7F                   ; avoid non-printable characters,
         BCS OUT_S                  ; this also fixes LIST command on PuTTY
         JMP      OUTCH             ; Output routine address.
OUT_S    RTS

BV       CLC                        ; always return NOT BREAK
         RTS                        ; Begin break routine         
